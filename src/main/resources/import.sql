INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('user', 'user01', 1, 'Arturo', 'Hernandez Navarro', 'hernandezn.arturo@gmail.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('admin', 'admin01', 1, 'José', 'Hernandez Navarro', 'turo.arturo@gmail.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('cocinero', 'cocinero01', 1, 'Keneth', 'Blandon Ramirez', 'kblandon_91@hotmail.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('cajero', 'cajero01', 1, 'Alejando', 'Sotico', 'sotico@hotmail.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('mesero', 'mesero01', 1, 'mesero', 'mesero', 'mesero@hotmail.com');
...
INSERT INTO  platillos  (nombre, precio, create_at, estado_id, tipo_id, image) VALUES ('Farinata genovesa o fainá', 2500.00,  GETDATE(), 1,1, 'C:\RestauranteImagenes\farinata.jpg'); --1
INSERT INTO  platillos  (nombre, precio, create_at, estado_id, tipo_id, image) VALUES ('SUPREMA (GRANDE)', 11950.00,  GETDATE(), 1,2, 'C:\RestauranteImagenes\pizza_jamon_y_queso.jpg');--2
INSERT INTO  platillos  (nombre, precio, create_at, estado_id, tipo_id, image) VALUES ('SUPREMA (MEDIANA)', 9950.00,  GETDATE(), 1,2, 'C:\RestauranteImagenes\pizza_jamon_y_queso.jpg');--3
INSERT INTO  platillos  (nombre, precio, create_at, estado_id, tipo_id, image) VALUES ('JAMÓN Y QUESO (GRANDE)', 11950.00,  GETDATE(), 1,2, 'C:\RestauranteImagenes\pizza_jamon_y_queso.jpg');--4
INSERT INTO  platillos  (nombre, precio, create_at, estado_id, tipo_id, image) VALUES ('JAMÓN Y QUESO (MEDIANA)', 9950.00,  GETDATE(), 1,2, 'C:\RestauranteImagenes\pizza_jamon_y_queso.jpg');--5
